...
def tela_ini():
    ...
    coluna1 = [
        ...
        [sg.Text('CIDADE', font='arial 12', pad=(5, 2))],
        [sg.Text('UNIDADE FEDERATIVA', font='arial 12', pad=(5, 2))],
        [sg.Text('POPULAÇÃO (IBGE)', font='arial 12', pad=(5, 2))],
    ...
    layout = [
        ...
        [sg.Text('Faça consulta de CEP e DDD para estados e cidades do Brasil',
                 font='arial 14', pad=(0, 0))],
        [sg.Button('CEP', font='arial 12', size=(8, 1), pad=(88, (30, 10))),
         sg.Button('DDD', font='arial 12', size=(8, 1), pad=(100, (30, 10)))],
        [sg.Frame(layout=coluna1, title='', element_justification='center',
                  pad=(30, 0)),
         sg.Frame(layout=coluna2, title='', element_justification='center',
                  pad=(30, (0, 104)))],
        [sg.CButton('Sair', font='arial 12', size=(8, 1), pad=(0, (50, 0)))],
        [sg.Text('@JoaoPROFECIA', pad=(0, (35, 0)))]
    ]

    telaprin = sg.Window('ConsultaBR', element_justification='center',
...
def tela_cep():
    ...
    coluna1 = [
        ...
        [sg.Text('POPULAÇÃO (IBGE):', font='arial 12')],
        [sg.Text('DDD:', font='arial 12')]
    ]

    coluna2 = [
        [sg.Input(font='arial 12 bold', background_color='white',
         key='logradouro', size=(35, 1))],
        [sg.Input(font='arial 12 bold', background_color='white',
         key='bairro', size=(30, 1))],
        [sg.Input(font='arial 12 bold', background_color='white', key='cidade',
         size=(30, 1))],
        [sg.Input(font='arial 12 bold', background_color='white', key='uf',
         size=(4, 1))],
        [sg.Input(font='arial 12 bold', background_color='white', key='ibge',
         size=(15, 1))],
        [sg.Input(font='arial 12 bold', background_color='white', key='ddd',
         size=(4, 1))]
    ]
    ...
    telaCep = sg.Window('ConsultaCEP', element_padding=(0, 10), layout=layout,
                        size=(600, 500), finalize=True)
...
def tela_ddd():
    ...
    ddd = [
        ...
        [sg.Input(size=(3, 0), font='arial 12', pad=(0, 0), key='ddd',
         background_color='white')],
        [sg.Button('Consultar', font='arial 12', size=(10, 1))]
    ]

    coluna1 = [
        [sg.Text('ESTADO:', font='arial 12', pad=(0, 0))],
        [sg.Text('CIDADES:', font='arial 12', pad=(0, 95))],
    ]

    coluna2 = [
        [sg.Input(font='arial 12 bold', key='estado', size=(35, 1),
         background_color='white')],
        [sg.Output(font='arial 12 bold', key='cidades', size=(35, 10),
         background_color='white')],
    ]
    ...
    layout = [
        ...
        [sg.Column(ddd, justification='center',
         element_justification='center')],
        [sg.Column(coluna1, pad=((0, 20), 0)), sg.Column(coluna2)],
        [sg.Column(botoes, justification='center')]
    ]

    teladdd = sg.Window('ConsultaDDD', element_padding=(0, 10),
                        layout=layout, size=(600, 500), finalize=True)
